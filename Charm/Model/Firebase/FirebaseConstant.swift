...
struct FirebaseConstants: FirebaseItem {
    ...
    var metricDescWord = "How your words captivate their mind"
    var metricDescConvo = "The flow of the conversation"
    var metricDescPersonal = "Who you focused the conversation on"
    var metricDescEmotions = "How your words triggered their emotions"
